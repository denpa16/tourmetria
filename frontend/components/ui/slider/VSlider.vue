<template>
    <div :class="['v-slider', classList]"
        ...
        <div v-if="showValue"
            ...
            <div ref="subtitle-1"
                 class="v-slider__val subtitle-1">
                <template v-if="range">
                    {{ formattedValue[0] }}
                </template>
                <template v-else>
        ...
        <div ref="rail"
            ...
            <div class="v-slider__track">
                ...
                <VSliderDot ref="dot1"
                            ...
                            @mouse-enter="handleDotMouseEnter(1)"
                            @mouse-leave="handleDotMouseLeave(1)"
                ...
                <VSliderDot v-if="range"
                            ...
                            @mouse-enter="handleDotMouseEnter(2)"
                            @mouse-leave="handleDotMouseLeave(2)"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleDotMouseEnter(val) {
                if (this.$refs[`subtitle-${val}`]) {
                    this.$refs[`subtitle-${val}`].classList.add('_active');
                }
                this.$emit('mouseenter-dot', val - 1);
            },

            handleDotMouseLeave(val) {
                if (this.$refs[`subtitle-${val}`]) {
                    this.$refs[`subtitle-${val}`].classList.remove('_active');
                }
                this.$emit('mouseleave-dot', val - 1);
            },
        },
    };
</script>
